...
using BlogProject.Core.CrossCuttingConcerns.Exceptions.HttpProblemDetails;
using BlogProject.Core.CrossCuttingConcerns.Exceptions.Types;
using Microsoft.AspNetCore.Http;

namespace BlogProject.Core.CrossCuttingConcerns.Exceptions.Handlers
{
    public class HttpExceptionHandler : ExceptionHandler
    {
        ...
        {
            get => _response ?? throw new InvalidOperationException("Response is not set");
            set => _response = value;
        }
